  ...
  <div class="auth-wrap" style="max-width:680px">
    ...
    <?php else: ?>
      ...
      <form method="post" action="/?page=client-onboarding-submit" style="display:grid;grid-template-columns:1fr 1fr;gap:14px">
        ...
        <label style="grid-column:1/-1"><span>Address line 2</span><input class="input" name="address_line2" maxlength="255" autocomplete="address-line2" value="<?php echo htmlspecialchars((string)($existingClient['address_line2'] ?? '')); ?>"></label>
