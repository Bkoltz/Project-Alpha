...
/* partials/document_list/rows/regular-contract-rows.twig */
class __TwigTemplate_851ecc4f517a2d98576fa165c8edcbcc extends Template
{
...
\t\t\t\t\t\t<a href=\"/?page=contract/contract-details&id=";
            ...
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["row"], "doc_number", [], "any", false, false, false, 19), "html", null, true);
            yield "</a>
\t\t\t\t\t</td>
\t\t\t\t\t<td style=\"padding:10px\">";
            // line 21
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["row"], "document_type", [], "any", false, false, false, 21), "html", null, true);
            yield "</td>
\t\t\t\t\t<td style=\"padding:10px\">
...
";
    ...
    {
        return "partials/document_list/rows/regular-contract-rows.twig";
    }
    ...
    {
        return new Source("", "partials/document_list/rows/regular-contract-rows.twig", "/var/www/src/views/partials/document_list/rows/regular-contract-rows.twig");
    }
}
