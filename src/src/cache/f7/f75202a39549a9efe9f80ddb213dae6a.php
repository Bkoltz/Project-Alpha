...
\t\t\t\t\t\t<td style=\"padding:10px\">Q-";
            // line 32
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["row"], "doc_number", [], "any", false, false, false, 32), "html", null, true);
            yield "</td>
\t\t\t\t\t\t";
            // line 33
            if ((($tmp = ($context["hasProject"] ?? null)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
...
\t\t\t\t\t\t\t<a href=\"/?page=client/clients-list&selected_client_id=";
            ...
            yield " ?>\">";
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["row"], "client", [], "any", false, false, false, 39), "html", null, true);
            yield "</a>
\t\t\t\t\t\t</td>
