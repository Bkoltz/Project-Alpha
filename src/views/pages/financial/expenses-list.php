...
<div style="max-width:1400px;margin:0 auto;padding:24px">
  <div class="page-head">
    <h2>Expenses</h2>
    <div class="flex">
      <a href="/?page=financial/expense-report" class="btn btn-sm">Report</a>
  ...
  <div class="card" style="margin-bottom:20px">
    <form method="get" action="/" class="grid" style="grid-template-columns:repeat(auto-fit,minmax(140px,1fr))">
      ...
      <div style="display:flex;align-items:end"><button type="submit" class="btn btn-primary">Filter</button></div>
    </form>
  </div>
