...
$portalProfiles=[];$portalWorkspaces=[];$portalWorkspaceLinks=[];$portalPrincipals=[];$portalManagers=[];$portalSchemaReady=true;
try{
...
<?php if(!$portalSchemaReady):?><div class="settings-alert settings-alert-warning" role="alert">Portal v2 administration is unavailable until migration 0066 completes.</div><?php else:?>
