...
<div class="settings-card">
 ...
 <form method="post" action="/?page=settings/external-ops-handler">
  ...
  <div class="settings-form-grid">
   <label class="check-row" style="grid-column:1/-1"><input type="checkbox" name="enabled" value="1" <?=!empty($config['enabled'])?'checked':''?>> Enable this external operations application</label>
