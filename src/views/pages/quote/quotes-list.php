...
if ($hasProj && $project_code !== '') {
  $where[] = 'q.project_code LIKE ?';
  $p[] = $project_code . '%';
}
if ($hasDoc && $doc_no > 0) {
  $where[] = 'q.doc_number=?';
...
<section>
          ...
          <tr style="border-top:1px solid #f3f4f6;<?php echo $rowStyle; ?>">
            ...
            <td style="padding:10px">
              <div style="display:flex;gap:6px;justify-content:flex-end">
                <a href="/?page=quote/quotes-details&id=<?php echo (int)$r['id']; ?>" style="padding:6px 10px;border:1px solid #ddd;border-radius:8px;background:#fff; font-size: small;">View</a>
  ...
  $qs = $_GET;
  unset($qs['p']);
  $base = '/?' . http_build_query($qs + ['page' => 'quote/quotes-list', 'per_page' => $per]);
  ?>
