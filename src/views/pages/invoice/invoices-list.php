...
<section>
  <div class="page-head">
    <h2>Invoices</h2>
    <a href="/?page=invoice/invoices-create" class="btn btn-primary">Create Invoice</a>
  </div>
      ...
      <tbody>
        <?php foreach ($rows as $r): ?>
          ...
          <tr style="<?php echo $rowStyle; ?>">
            <td>I-<?php echo (int)($r['doc_number'] ?? $r['id']); ?></td>
            ...
            <td><?php echo (!empty($r['due_date'])) ? date('m/d/Y', strtotime($r['due_date'])) : ''; ?></td>
            <td>
              <div class="flex" style="align-items:center;gap:6px">
              <a href="/?page=invoice/invoice-details&id=<?php echo (int)$r['id']; ?>" class="btn btn-sm">View</a>
            ...
            <td>
              <?php if ($r['status'] !== 'paid'): ?>
                <a href="/?page=invoice/invoices-edit&id=<?php echo (int)$r['id']; ?>" class="btn btn-sm">Edit</a>
              <?php else: ?>
