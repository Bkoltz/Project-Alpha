...
<body>
  ...
  $isPublicPage = isset($_GET['page']) && in_array($_GET['page'], ['public-doc', 'public_doc', 'public-redirect', 'public_redirect', 'client-onboarding', 'stripe-checkout', 'stripe-success'], true);
  ?>
