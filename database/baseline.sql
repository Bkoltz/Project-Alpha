...
CREATE TABLE IF NOT EXISTS project_invoice_payments (
    ...
    processor_provider VARCHAR(50) NULL,
    processor_payment_id VARCHAR(255) NULL,
    processor_gross_amount DECIMAL(12,2) NULL,
    processor_fee_amount DECIMAL(12,2) NULL,
    processor_net_amount DECIMAL(12,2) NULL,
    processor_fee_policy VARCHAR(32) NOT NULL DEFAULT 'unknown',
    processor_fee_source VARCHAR(32) NOT NULL DEFAULT 'unknown',
    stripe_session_id VARCHAR(255) NULL,
    ...
    INDEX idx_project_payment_processor (processor_provider, processor_payment_id),
...
CREATE TABLE IF NOT EXISTS payments (
    ...
    processor_provider VARCHAR(50) NULL,
    processor_payment_id VARCHAR(255) NULL,
    processor_transaction_id BIGINT NULL,
    processor_gross_amount DECIMAL(12,2) NULL,
    processor_fee_amount DECIMAL(12,2) NULL,
    processor_net_amount DECIMAL(12,2) NULL,
    processor_fee_policy VARCHAR(32) NOT NULL DEFAULT 'unknown',
    ...
    UNIQUE KEY uq_payments_processor_payment (processor_provider, processor_payment_id),
    INDEX idx_payments_processor_transaction (processor_transaction_id),
