...
-- Users table: ensure role and updated_at columns exist
...
-- Contracts: add fields if missing
...
-- Invoices: add scheduled fields if missing
...
-- Project tables (idempotent creates)
...
-- Add project_code to documents if missing
...
-- Add doc_number to documents if missing
