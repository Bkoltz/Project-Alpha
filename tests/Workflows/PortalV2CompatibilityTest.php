...
final class PortalV2CompatibilityTest extends TestCase
{
    ...
    public function testStaffAuthorityUxIsResponsiveKeyboardNativeAndSeparatedFromContacts():void
    {
        ...
        self::assertStringContainsString('<details>',$page);self::assertStringContainsString('<summary class="btn btn-sm">Edit</summary>',$page);
    ...
    public function testDisablingProfileQueuesScopedRevocationBeforeStateChange():void
    {
        ...
        self::assertSame([[1]],$pdo->query('SELECT integration_profile_id FROM portal_projection_outbox ORDER BY id')->fetchAll(PDO::FETCH_NUM));
